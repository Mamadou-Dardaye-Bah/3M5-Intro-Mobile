...
Observes-tu un comportement surprenant ? Si oui, explique-le dans tes propres mots et tente d’en identifier la cause. Pour t'aider, tu peux te référer à ces explications : [Typse valeur vs types référence (2P6)](https://info.cegepmontpetit.ca/2P6/cours/valeur-reference)
